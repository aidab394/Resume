			...
			<form type="get">
				<table width="1200" border="1">
					<tr>
						...
						<td align="left" width="1000"><input type="text" name="FirstName" placeholder="Ex. John" maxlength="30" size="47" required></td>
					</tr>
					<tr>
						<td align="right" width="200">Surname: </td>
						<td align="left" width="1000"><input type="text" name="Surname" placeholder="Ex. Doe" maxlength="30" size="47" required></td>
					</tr>
					<tr>
