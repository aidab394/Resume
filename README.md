<html lang="en">
 ...
 <body>
	<p><img src="banner4.jpg" alt="Header image" width="100%" align="top"></p>
	<h2>Biography</h2>
		<blockquote>
			...
			<form type="get">
				<table width="1200" border="1">
					<tr>
						...
						<td align="left" width="1000"><input type="text" name="FirstName" placeholder="Ex. Aida" maxlength="30" size="47" required></td>
					</tr>
					<tr>
						<td align="right" width="200">Surname: </td>
						<td align="left" width="1000"><input type="text" name="Surname" placeholder="Ex. Bevrnja" maxlength="30" size="47" required></td>
					</tr>
					<tr>
						<td align="right" width="200">E-mail: </td>
						<td align="left" width="1000"><input type="text" name="Email" placeholder="example@example.com" size="47" maxlength="30" required></td>
					</tr>
					<tr>
						<td align="right" width="200">Message: </td>
						<td align="left" width="1000"><textarea cols="100" maxlength="1000" rows="10" placeholder="Please type Your message here." required></textarea></td>
					</tr>
					<tr>
						<td width="200"></td>
