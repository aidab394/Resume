<html lang="en">
 ...
 <body>
 	<img src="banner4.jpg" alt="Header image" height="500" width="1200" align="top">
	<h2>Biography</h2>
		<blockquote>
			...
			<form type="get">
				<table width="1200" border="1">
					...
					<tr>
						...
						<td align="left" width="1000"><textarea cols="103" maxlength="1000" rows="10" placeholder="Please type Your message."></textarea></td>
					</tr>
					<tr>
						<td width="200"></td>
